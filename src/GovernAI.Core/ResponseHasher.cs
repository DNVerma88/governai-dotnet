...
/// <summary>
/// Computes a SHA-256 or HMAC-SHA256 hash of a response string.
/// </summary>
public static class ResponseHasher
{
    /// <summary>
    /// Computes a hash of the specified response text.
    ...
    /// </summary>
    /// <param name="response">The response to hash. May be <see langword="null"/> or empty.</param>
    /// <param name="key">
    ...
    /// <paramref name="response"/> is <see langword="null"/> or empty.
    /// </returns>
    public static string Hash(string? response, byte[]? key = null)
    {
        ...
        var inputBytes = Encoding.UTF8.GetBytes(response);
